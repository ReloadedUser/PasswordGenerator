...
### Output:
- a password with the length **amount of numbers** + **amount of characters** + **amount of symbols** . The amount of numbers, characters and symbols is taken from the __user input__.
### Disclaimer:
